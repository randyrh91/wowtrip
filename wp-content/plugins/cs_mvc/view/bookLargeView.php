...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="col-xs-12 col-md-7 col-sm-6 col-md-push-5 col-sm-push-6">
                <!-- Destinos Turisticos -->
            ...
            <div class="col-xs-12 col-md-5 col-sm-6 col-md-pull-7 col-sm-pull-6 column-slider">
                <!-- Carrucel -->
        ...
        <div style="clear: both"></div>
        <div class="col-xs-12 col-md-12 col-sm-12">
            <h3 style="color: #EF8217; text-align: center"><em class="fa fa-calendar"></em> <?= __(CS_L_PROGRAMA) ?></h3>
