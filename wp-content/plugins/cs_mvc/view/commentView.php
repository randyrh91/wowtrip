...
<div class="container-fluid">
    <div class="row-fluid">
        <h1 style="text-align: center"><em class="fa fa-book"></em> <?=__(CS_L_VISITORBOOK)?> (<?=count(get_comments())?>)</h1>
        <?php
                    ...
                    <div id="respond">
                        ...
                        <?php else : ?>
                            ...
                            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                                ...
                                <textarea style="width: 100%" name="comment" id="comment" cols="100%" rows="10" tabindex="4"></textarea><br />
