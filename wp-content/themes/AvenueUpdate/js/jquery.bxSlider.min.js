...
(function (a) {
    a.fn.bxSlider = function (b) {
        ...
        function H() {
            I(b.startingSlide);
            if (b.mode == "horizontal") {
                e.wrap('<div class="' + b.wrapperClass + '" style="width:100%; position:relative;"></div>').wrap('<div class="bx-window" style="position:relative; overflow:hidden;"></div>').css({
                    width: "999999px",
                    position: "relative",
                    left: "-" + y + "px"
                });
                ...
                e.wrap('<div class="' + b.wrapperClass + '" style="width:100%; position:relative;"></div>').wrap('<div class="bx-window" style="height:' + m + 'px; position:relative; overflow:hidden;"></div>').css({
                    height: "999999px",
                    position: "relative",
                    top: "-" + z + "px"
                });
                ...
                e.wrap('<div class="' + b.wrapperClass + '" style="width:100%; position:relative;"></div>').wrap('<div class="bx-window" style="height:' + w + 'px; position:relative; overflow:hidden;"></div>');
